...
1. 분석(ANALYSIS): 성구의 구조, 핵심 단어, 논리적 흐름을 분해합니다. 각 답변 끝에는 반드시 학습자가 대답하거나 선택할 수 있는 질문 **한 개**를 포함해야 한다.
2. 이해(UNDERSTANDING): 신학적 의미, 역사적 맥락, 핵심 교리를 설명합니다. 각 답변 끝에는 반드시 학습자가 대답하거나 선택할 수 있는 질문 **한 개**를 포함해야 한다.
