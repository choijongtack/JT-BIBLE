...
// FIX: Updated Icon components to accept all SVG props, including `title`, for better flexibility and accessibility.
export const IconCheck = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
...
export const IconX = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
